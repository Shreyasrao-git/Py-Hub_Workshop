#TicTacToe game program using pygame
#Program Begins...
#Importing required packages and modules for the program
import pygame
...
initaiting_window = pygame.image.load("C:/Users/u s e r/Desktop/image.png")
initaiting_window = pygame.transform.scale(initaiting_window, ((width, height + 100)))
x_img = pygame.image.load("C:/Users/u s e r/Desktop/ximg.png") #
o_img = pygame.image.load("C:/Users/u s e r/Desktop/oimg.png")
...
#User playing the game by a mouse click...
def user_click():
...
#Game reset after completing the previous game
def reset_game():
